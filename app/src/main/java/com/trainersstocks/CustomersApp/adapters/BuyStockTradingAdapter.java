...
public class BuyStockTradingAdapter extends RecyclerView.Adapter<BuyStockTradingAdapter.STHolder> {
    ...
    public BuyStockTradingAdapter(Context context, ArrayList<BuyStockModel> list, RvListUtils rvListUtils, String buy_sell) {
    ...
    public STHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_stocktrading, parent, false);
