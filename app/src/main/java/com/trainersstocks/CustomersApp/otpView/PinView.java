...
public class PinView extends AppCompatEditText {
    ...
    private OnOtpComplete onotpcomplete;
    ...
    private void moveSelectionToEnd() {
        ...
        if (mPinItemCount == getText().length()) {
            onotpcomplete.OnOtpComplete();
        }
    }

    public void setOnOtpCompleteListner(OnOtpComplete onOtpCompleteListner){
        this.onotpcomplete = onOtpCompleteListner;
    }
